...
#model_name = 'titled_100_symmetric_auto'
#topicn=10
#wordn=20
#docn=5
#replacementsf='../doc/replacements.json'
# load the model, and the saved bug<->id map
...
corpus = mmcorpus.MmCorpus('titled.corpus')
corpus_sparse=corpus2csc(corpus, num_terms=len(model.id2word.token2id)).T
docsXtopics = mmcorpus.MmCorpus('docsXtopics.corpus')
